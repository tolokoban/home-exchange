                ...
                <div>
                    ...
                    <ul>
                        <li>
                            ...
                            <br />
                            It's very sensitive to water. The smallest drop and
                            it will start beeping. If it happens, just clean it
                            up and restart it.
                        </li>
                        <li>
                            There is a hoven and a microwave in the right
                            column.
                        </li>
                        <li>
                            If you have too much sun, there is a button on the
                            left side of the hoven column to control the
                            electric curtain.
                        </li>
                    </ul>
                </div>
