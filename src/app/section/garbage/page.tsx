  ...
  return (
    <ViewStrip fullsize orientation="column" template="*1">
      ...
      >
        ...
        <div>
          <p>
            Most of the garbage goes into the trash bins on the cemetary parking
            (point <b>1</b> on the map below).
          </p>
          <p>
            It's not mandatory (though much appreciated) but you can do
            selective sorting of waste if you like to.
            <br />
          ...
          <img src="image/black-boxes.jpg" alt="Black boxes" />
          <p>
            If the boxes are full, you can emty them in the trash bins in the
            village center (point <b>2</b> on the map below).
          </p>
          <img
