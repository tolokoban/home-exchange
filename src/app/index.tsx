...
export default function App({ lang }: { lang?: string }) {
    ...
    return (
        <Route path="/" Page={pg0} NotFound={NotFound0} fallback={fb} context={context}>
            <Route path="/section" NotFound={NotFound0} fallback={fb} context={context}>
                <Route path="/section/doors" Page={pg2} NotFound={NotFound0} fallback={fb} context={context}/>
                <Route path="/section/garbage" Page={pg3} NotFound={NotFound0} fallback={fb} context={context}/>
                <Route path="/section/internet" Page={pg4} NotFound={NotFound0} fallback={fb} context={context}/>
                <Route path="/section/kitchen" Page={pg5} NotFound={NotFound0} fallback={fb} context={context}/>
                <Route path="/section/tourism" Page={pg6} NotFound={NotFound0} fallback={fb} context={context}/>
            </Route>
        </Route>
    )
}
